...
class UserForm(forms.ModelForm):
    ...
    # Clar_username para validar se o usuario e emails estão  disponíveis
    def clean_username(self):
        username = self.cleaned_data.get('username')
        if User.objects.filter(username=username).exists(): # FAlat criar ocampo senha  no formulario para o usuario criar
