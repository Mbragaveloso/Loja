...
class BasePerfil(View):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Criar os formulários e adicioná-los ao contexto
        ...
        # Adicionar um formulário vazio com a chave 'form' ao contexto
        contexto['form'] = forms.UserForm()  # Você pode escolher qualquer um dos seus formulários aqui
         # Adicionar um formulário vazio com a chave 'perfilform' ao contexto
        contexto['perfilform'] = forms.PerfilForm()  # Você pode escolher qualquer um dos seus formulários aqui

        return contexto

    def get(self, request, *args, **kwargs):
        # Obter o contexto dos formulários
    ...
    def post(self, request, *args, **kwargs):
        ...
        if userform.is_valid() and perfilform.is_valid():
            ...
            perfil.usuario = request.user if request.user.is_authenticated else None
            perfil.save()
...
class Criar(BasePerfil):
    def post(self, request, *args, **kwargs):
        ...
        # Observe que o redirecionamento do carrinho foi removido, pois não está claro o que você deseja fazer aqui
        return render(request, self.template_name, contexto)
