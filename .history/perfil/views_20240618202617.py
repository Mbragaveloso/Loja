...
class CriarPerfilView(FormView):
    ...
    def get_success_url(self):
        # Retorna a URL de detalhes do perfil no admin, após o cadastro bem-sucedido
        return reverse_lazy('admin:perfil_perfil_change', args=(self.object.id,))
...
if request.method == 'POST':
        ...
        if form.is_valid():
            user = form.save()  # Salva o usuário se o formulário for válido
            return redirect('sucesso')  # Redireciona para página de sucesso após registro
    else:
        form = UserForm()
