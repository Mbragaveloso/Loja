...
class CriarPerfilView(View):
    ...
    form_class = UserForm  # Ajuste para o seu formulário de criação de perfil

    def get(self, request):
        if request.user.is_authenticated:
            return redirect('perfil:criar.html') # Redireciona se já estiver autenticado
    ...
    def post(self, request):
        ...
        if form.is_valid():
            # Lógica para salvar o formulário e autenticar o usuário
            user = form.save()
            ...
            if user is not None:
                ...
                return redirect('perfil:atualizar')  # Redireciona após o cadastro bem-sucedido
            else:
