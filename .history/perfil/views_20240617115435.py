...
class CriarPerfilView(View):
    ...
    def post(self, request):
        ...
        if user_form.is_valid() and perfil_form.is_valid():
            ...
            # Recuperando o perfil criado para exibir na página
            perfil_criado = Perfil.objects.get(usuario=user)  # Ajuste conforme a estrutura do seu modelo

            # Contexto para renderizar na página
            context = {
                'user_form': UserForm(),
                'perfil_form': PerfilForm(),
                'perfil_criado': perfil_criado  # Adicione o perfil criado ao contexto
            }
