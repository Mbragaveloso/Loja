...
from .forms import UserForm, PerfilForm  # Ajuste o import para seus formulários corretos
from .models import ModelForm # Ajuste o import para o modelo Perfil
...
class CriarPerfilView(View):
    ...
    def post(self, request):
        ...
        if user_form.is_valid() and perfil_form.is_valid():
            ...
            return redirect('produto:lista')   # Redireciona após a criação do perfil
        return render(request, self.template_name, {'user_form': user_form, 'perfil_form': perfil_form})
