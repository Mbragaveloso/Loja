...
class FinalizarCompra(View):
    def post(self, request, *args, **kwargs):
        ...
        for item in carrinho.values():
            preco_unitario = float(item.get('preco_unitario_promocional') or item['preco_unitario'])
...
class PedidoConfirmado(View):
    def get(self, request, *args, **kwargs):
        ...
        del request.session['produtos_no_carrinho']
        del request.session['total']

        return render(request, 'produto/pedido_confirmado.html', context)
