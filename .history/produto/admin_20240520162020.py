...
cclass ProdutoAdmin(admin.ModelAdmin):
    ...
    fields = ('nome', 'descricao_curta', 'descricao_longa', 'imagem', 'slug', 'preco_marketing', 'preco_marketing_promocional', 'tipo')aos campos somente leitura
