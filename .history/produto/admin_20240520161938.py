...
class ProdutoAdmin(admin.ModelAdmin):
    list_display = ('nome', 'preco_marketing', 'preco_marketing_promocional', 'imagem_preview', 'tipo')  # Adicionando 'imagem_preview' à lista de exibição
    fields = ['nome', 'descricao_curta','descricao_loga', 'preco_marketing', 'preco_marketing_promocional', 'imagem']  # Incluindo 'imagem' nos campos editáveis
