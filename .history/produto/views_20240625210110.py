...
class FinalizarCompra(View):
   def finalizar_compra(request):
    # Recupere o pedido, por exemplo, filtrando pelo usuário logado ou outra lógica adequada ao seu sistema
    pedido = Pedido.objects.get(id=id_do_pedido)  # Substitua pelo seu método de recuperação do pedido
