    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preco_marketing', models.FloatField(default=0.0, validators=[django.core.validators.MaxValueValidator(99.0)], verbose_name='Preço')),
                ('preco_marketing_promocional', models.FloatField(validators=[django.core.validators.MinValueValidator(0.01)], verbose_name='Preço Promo.')),
